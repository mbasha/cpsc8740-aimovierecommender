...
def get_recommendations(user_ratings: dict, n: int = 10, exclude_ids: list = None) -> list:
    ...
    # Add user ratings multiple times to amplify their influence on the model.
    # The more repetitions, the more the model is pulled toward the user's
    # actual preferences rather than global averages.
    repetitions = 20
    new_rows = []
    ...
    combined = pd.concat([ratings_df, new_rows_df], ignore_index=True)
